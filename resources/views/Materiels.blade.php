...
<div class="container py-5">
    <div class="card shadow-lg" style="border-radius: 15px;">
        ...
        <div class="card-header text-white text-center" style="background: linear-gradient(135deg, #4e73df, #224abe); border-radius: 15px 15px 0 0;">
            <h2><i class="fas fa-tools"></i> Ajout des Matériels de Bureau</h2>
        </div>
        <!-- Corps de la carte -->
        <div class="card-body" style="background-color: #f8f9fc; border-radius: 0 0 15px 15px;">
            ...
            <form action="{{ route('materiels.store') }}" method="POST" class="needs-validation" novalidate>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6">
                        <label for="motifs" class="form-label">
                            <i class="fas fa-comment"></i> Motifs
                        </label>
                        <input type="text" class="form-control shadow-sm" id="motifs" name="motifs">
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control shadow-sm" id="nature" name="nature">
                    </div>
                    <div class="col-md-4">
    ...
    @endforeach
                ...
                <div class="d-grid gap-3 mb-3">
                    ...
                    <a href="{{ route('liste') }}" class="btn btn-primary btn-lg shadow-sm" style="background: linear-gradient(135deg, #6a11cb, #2575fc); border: none;">
                        <i class="fas fa-list"></i> Liste des Matériels
                    </a>
                </div>
            </form>
        </div>
